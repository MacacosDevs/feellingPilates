# PN14 Slice2 — manifest físico de entrada local documental auditada

Status: CONDITIONAL / PENDING_FINAL_VERIFY_AND_FINAL_GATE / NOT_SATISFIED_AT_MATERIALIZATION.
Este manifest se creó **último**, después de los cinco core docs. No contiene su propio SHA
ni el aggregate rawafter470. Ambos se entregan externamente por materializador/verificador/
coordinador y se enlazan por gate final competente; no hay selfhash ni ciclos.
Autoridad normativa y regla de interpretación condicional: checkpoint Slice2 §§5–6,8 y
appends competentes de ESTADO/mapa. Este manifest enumera/protege bytes; no se autoautoriza.

## 1. Contrato físico finito y provenance

```json
{
  "kind": "LOCAL_UNCOMMITTED_AUDITED_DOCUMENTATION_ENTRY",
  "statusAtMaterialization": "CONDITIONAL_PENDING_FINAL_VERIFY_AND_FINAL_GATE_NOT_SATISFIED",
  ...
  "manifestSHA256": "EXTERNAL_ONLY_NO_SELF_HASH",
  "rawAfter470Digest": "EXTERNAL_ONLY_NO_SELF_HASH_CYCLE",
  "entryDirtyExactPaths": [
  ...
  "allowedDocumentationDelta": [
    {
      "path": "auditoria/ESTADO-ACTUAL.md",
      "mode": "APPEND_ONLY_END_BY_ACCEPTANCE_MATERIALIZER",
      "executorWritePermission": "NONE"
    },
    {
      "path": "auditoria/contexto/MAPA-LEGACY-Y-MIGRACION.md",
      "mode": "APPEND_ONLY_END_BY_ACCEPTANCE_MATERIALIZER",
      "executorWritePermission": "NONE"
    },
    {
      "path": "auditoria/fase-pn14-slice2-autorizacion-orden-snapshot-inmutable.md",
      "mode": "APPEND_ONLY_END_BY_ACCEPTANCE_MATERIALIZER",
      "executorWritePermission": "NONE"
    },
    {
      "path": "auditoria/handoffs/HANDOFF-PN14-SLICE2-ORDEN-SNAPSHOT-INMUTABLE.md",
      "mode": "PREEXISTING_CREATE_IMMUTABLE_NO_OWN_WRITE",
      "executorWritePermission": "NONE"
    },
    {
      "path": "auditoria/reviews/PN14-SLICE2-MANIFEST-ENTRADA-LOCAL-ORDEN-SNAPSHOT-INMUTABLE.md",
      "mode": "CREATE_BY_ACCEPTANCE_MATERIALIZER",
      "executorWritePermission": "NONE"
    },
    {
      "path": "auditoria/reviews/PN14-SLICE2-REVIEW-AUTORIZACION-ORDEN-SNAPSHOT-INMUTABLE.md",
      "mode": "CREATE_BY_ACCEPTANCE_MATERIALIZER",
      "executorWritePermission": "NONE"
    }
  ],
  "publishedBaseline": {
    "count": 466,
    "raw466": "83cbda445a593d825edbb4501f13dde4d543aaf27bc6c1c550277b77897e3ec4",
    "authorityPreflightTask": "task_de18059bcee1",
    "provenance": "coordinator_independent_physical_preflight",
    "tableSource": "ACTUAL_TASK_RESULT_JSON_all466FileSHA256",
    "tableVerifiedAgainstPhysicalEntry": true,
    "allOther464OriginalByteIdentical": true,
    "HEADFiltered466RawMatch": true,
    "checkoutRule": "git cat-file --filters HEAD:path preserves mvnw.cmd CRLF (.gitattributes); no edits",
    "mvnwCmdRawSHA256": "46eedb8419bd14fe70d5bb2916d7b6f51806e51b39d5b76a42610384ca929c1c",
    "appendExceptions": [
      {
        "path": "auditoria/ESTADO-ACTUAL.md",
        "publishedPrefixBytes": 50823,
        "publishedPrefixSHA256": "afb415473e15cbeb3045634efabd200546c8397a6d10f1b4f44f7db3b2513f50",
        "candidatePrefixBytes": 56562,
        "candidatePrefixSHA256": "8d6ceb14d421138e8979150908150bf533c903189f50b4ee54092c890d6496b6"
      },
      {
        "path": "auditoria/contexto/MAPA-LEGACY-Y-MIGRACION.md",
        "publishedPrefixBytes": 40907,
        "publishedPrefixSHA256": "2c155ba748fdcf1e9d4c831521234fde01e4d74ec9f78ed7e47878b2067a5a26",
        "candidatePrefixBytes": 46456,
        "candidatePrefixSHA256": "359d2de16d77152918f5d95ba1439360bc1b457825bbf46455bf19fb1df7e877"
      }
    ]
  },
  "candidateCheckpointPrefix": {
    "path": "auditoria/fase-pn14-slice2-autorizacion-orden-snapshot-inmutable.md",
    "bytes": 15452,
    "SHA256": "3667b955b539d95a217c3976c884f935594564e662e7a6669c1a2e7ff9990cfd"
  },
  "materializerBefore": {
    "count": 468,
    "digest": "ac186d04179d105bfa9b5e2110462007e61ec06a52b88ec08db7e05458d498cf",
    "baselineDirtyCount": 4,
    "reviewAbsent": true,
    "manifestAbsent": true
  },
  "sourcePom362": "b8da272df924b885c4466ba3a92fc7c6a90ab5ddb296bc1d31fe5e570b98315a",
  "slice1Tests13": "ec74b9a88b945547ae0010eda81bbaa11cfb9ae0ab595985b95e991b35f02929",
  "migrations": {
    "count": 50,
    "maxMajor": 47,
    "digest": "e2848476012dc44133776cad500f2bb0870ecf7c1b66cdd9dbcab0ee5fddb398",
    "checksums": "all 50 exact paths/rawSHA in published466FileSHA256 table below",
    "V48Absent": true,
    "V49Absent": true,
    "renumberPermission": "NONE"
  },
  "futureCreatePaths": [
    {
      ...
      "observedAtMaterializerEntry": "ABSENT",
      "existingSourceUpdatePermission": "NONE"
    },
    {
  ...
  "authority": {
    ...
    "initialFreshAuditor": {
      ...
      "uniqueDoneCount": 1,
      "settledReleased": true,
      "bodyVerdict": "SLICE2_AUTHORIZATION_AUDIT=PASS",
      "modelObservedLiteral": "UNREPORTED",
    ...
    "initialGate": {
      "task": "task_42c555e7bf1d",
      "gate": "gate_e031cf779ca1",
      "status": "RESOLVED",
      "resolution": "PASS",
      ...
      "permission": "LIMITED_DOCUMENTARY_ACCEPTANCE_ONLY"
    },
    "finalVerifier": {
      "task": "task_807e559a0955",
      "status": "PENDING",
      "required": "completed succeeded uniqueDoneaccepted SLICE2_FINAL_AUTHORIZATION_VERIFICATION=PASS P0=P1=0 filesModified=[]"
    },
    "finalGate": {
      "task": "task_fe41eb6e6c0d",
      "gate": "gate_6f54babec421",
      "status": "PENDING",
      "required": "completed RESOLVED/PASS coordinator_gate_resolution candidateFileSHA256 AND authorityFileSHA256 exact6 plus localEntryManifestSHA256/rawentry470 equal writer/verifier/coordinator physical"
    }
  },
  "publicationPermission": "NONE",
  "publication": "NOT_PERFORMED",
  "autoPublish": false,
  "currentImplementation": "NOT_STARTED_NOT_AUTHORIZED_AT_MATERIALIZATION",
  "futureAuthorityWhenActualFinalConditionTrue": "SLICE2_AUTHORIZED_TO_IMPLEMENT / IMPLEMENTATION_NOT_STARTED / IMPLEMENTATION_AUTHORITY_SLICE2_ONLY",
  "slices3to12": "NOT_AUTHORIZED",
  "Slice1": "PUBLISHED_CLOSED_TERMINAL_NO_FURTHER_WRITES",
  "PN13": "ACCEPTED_PUBLISHED_CLOSED",
  "newWriterFindings": "NOT_ASSESSED",
  "combinedFindingsSource": "AJENO_INITIAL_AUDIT_ONLY_0_0_1_NEW-PN13-017",
  "testsHostCurrent": "NOT_APPLICABLE_NOT_EXECUTED",
  "launchRequestedEffective": {
    "requested": {
      "agent": "codex",
      "model": null,
      "effort": null
...
## 2. Tabla completa publicada — 466 path → SHA256 raw

Tabla literal íntegra recuperada del result JSON de task_de18059bcee1,
all466FileSHA256, provenance coordinator_independent_physical_preflight.
Verificada contra snapshot propio completo468: todos464 sin excepción idénticos;
ESTADO/mapa se comparan por completo50823/40907 prefixes publicados. También se comprobó
todo466 contra HEAD1564 con checkout filtering CRLF seguro de mvnw.cmd.
Algoritmo aggregate: UTF8 sorted exactpath + NUL + SHA256(raw bytes) + LF,
SHA256(concatenation). Aggregate raw466 83cbda445a593d825edbb4501f13dde4d543aaf27bc6c1c550277b77897e3ec4.
Las dos excepciones sólo permiten append al END; la tabla conserva sus hashes originales,
no hashes actuales de documentos ampliados. CoreFileSHA256 contiene los actuales de cinco docs.
...
```json
{
  ...
  "auditoria/ESTADO-ACTUAL.md": "afb415473e15cbeb3045634efabd200546c8397a6d10f1b4f44f7db3b2513f50",
  ...
  "auditoria/contexto/MAPA-LEGACY-Y-MIGRACION.md": "2c155ba748fdcf1e9d4c831521234fde01e4d74ec9f78ed7e47878b2067a5a26",
...
## 3. Preflight obligatorio y protección final sin edición posterior

Esta entrada **no requiere publicación documental previa**, pero sólo es efectiva con condición
final real del checkpoint§8. Leer task/gate/message/Dispatch físicos, un uniqueDone de verifier
accepted succeeded/PASS, finalgate real PASS con provenance coordinador y mapas exactos **seis**
candidateFileSHA256 y authorityFileSHA256, SHA externo manifest y raw470 iguales entre
materializador/verificador/coordinador. NOT_SATISFIED aquí; no futuros PASS fabricados.
No editar ninguno de los seis docs después del finalgate: la regla condicional vigente basta.

Antes de cualquier write futuro: worktree/branch, localHEAD/upstream/live1564, EMPTY staging,
index físico/entries originales, exact6dirty enumerados completos, cinco coreSHA y SHA externo
manifest, todo466 publicado con sólo las dos excepciones append/prefixes, candidate prefixes
56562/46456/checkpoint15452 íntegros, handoff immutable acceptedSHA. Snapshot completo physical470
y hashes antes de ejecución corresponden al binding externo final, no tolerancia a paths extra.
Comparar TODOS los protected before468 paths excluyendo sólo los cinco ownpaths; no atribuir
baseline ajeno al executor/materializador. Review/manifest ABSENT en entrada del materializador.

Los 32 futureCREATE exactos siguen ABSENT, incluyendo candidatos no tracked; ninguna fuente/
test/SQL/config existente dirty desconocida. Migrations50 y cada checksum de tabla idénticos,
max47 y V48/V49 absent; versiones/nombres conditionalCREATE exactos, nunca renumeración silenciosa.
HEAD change, candidato existente, docs/manifest/rawentry mismatch o evidencia unknown/stale:
STOP / AUTHORIZATION_MISMATCH / NO_WRITES y reconciliación competente, no dirty waiver general.

Fullbaseline competente **BEFORE ANY WRITE**, seguido de nueva focal/oldfocal/full, JDK21 y
PostgreSQL16 dummy fresh/upgradeV47, matriz T01–T18/M01–M12, controles exigibles íntegros del
handoff§8. Las huellas históricas Slice1/baseline590/full638 no sustituyen el nuevo baseline.
No Maven/host/SQL en este Run documental. No Git writes en este Run ni primera ejecución futura.
Sin globs autorizantes o UPDATE a source existente; contrato completo immutable handoff§§1–9.
Ningún pago/crédito/ledger/reader/writer/runtime switch/fence/cutover habilitado.
PN13 y Slice1 CLOSED; Slice1 sin furtherwrites, later3–12 NOT_AUTHORIZED; NEW17 OPEN/P2 preservado.
Publicación/cierre requieren otros roles y autorización separada, auto_publish=false.
