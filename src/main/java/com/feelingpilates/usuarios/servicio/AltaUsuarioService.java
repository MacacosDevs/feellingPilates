...
public class AltaUsuarioService {
    ...
    @Transactional
    public UsuarioResponse crearClienteSalon(CrearClienteRequest request) {
    ...
    @Transactional
    public Usuario crearClienteRegistro(String correo, String nombre, String contrasenaPlano) {
